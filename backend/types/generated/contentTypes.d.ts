...
export interface ApiMemberMember extends Schema.CollectionType {
  ...
  attributes: {
    ...
    hrog: Attribute.Boolean;
    lost: Attribute.Boolean;
    chapterEternal: Attribute.Boolean;
    canEmail: Attribute.Boolean;
    nationalId: Attribute.String;
    initiationDate: Attribute.Date;
    initiationNumber: Attribute.String;
    ...
    > &
      Attribute.DefaultTo<'Mr.'>;
    suffix: Attribute.Enumeration<
      ['Jr.', 'Sr.', 'I', 'II', 'III', 'IV', 'Ph.D.', 'M.D.']
    >;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    content: Attribute.DynamicZone<['sections.scroll-section']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
